...
## 2.9.0 (Unreleased)
- [Fix] Variant ensure block uses `= nil` instead of `delete`, leaving stale nil entries in `Fiber.current.waterdrop_clients` causing memory leak in long-running processes (#836).
